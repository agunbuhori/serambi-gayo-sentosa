<?php namespace App\Http\Controllers;
	...
	class AdminIndukMaterialBawangController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    */
	    public function hook_query_index(&$query) {
	        $query->whereNull('parent_id')->where('jenis', 'bawang');
